        ...
        tabify: function(init) {
            ...
            this.$tabs.each(function(i, a) {
                ...
                // remote tab
                    ...
                    self.$panels = self.$panels.add(
                        $('#' + id)[0] || $(o.panelTemplate).attr('id', id).insertAfter( self.$panels[i - 1] || self.source )
                    );
					$("#tabs").addClass(o.panelClass);
                }
                // invalid tab href
                else {
                    o.disabled.push(i + 1);
            ...
            if (init) {
                ...
                this.$panels.each(function() {
					...
					//$this.parent().hasClass(o.panelClass) || $this.parent().addClass(o.panelClass);
					$("#tabs").hasClass(o.panelClass) || $("#tabs").addClass(o.panelClass);
                });
        ...
        add: function(url, text, position) {
            if (url && text) {
                ...
                $panel = $panel.length && $panel
                    || $(o.panelTemplate).attr('id', id).addClass(o.hideClass);
				//$(o.panelTemplate).parent().addClass(o.panelClass);
				$("#tabs").addClass(o.panelClass);
