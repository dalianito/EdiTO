...
public class QueryConsultantDashboardDataAjaxAction extends AjaxAction {
    ...
    private void setHistoryData() throws Exception{
        ...
        sql += "AND employeeUuid='" + employeeUuid + "' ";
    ...
    private int getCurWeekNoOfConsultations() throws RemoteException, Exception{
        return getNoOfCommunications(Constants.DEFAULT_OPTION_CONSULT_COMMUNICATION_TYPE_CONSULTATION_UUID, DateUtil.getCurWeekStartTime(), null);
    }
    ...
    private int getCurWeekNoOfCompletedFollowUps() throws RemoteException, Exception {
        return getNoOfCommunications(Constants.DEFAULT_OPTION_CONSULT_COMMUNICATION_TYPE_FOLLOW_UP_UUID, DateUtil.getCurWeekStartTime(), null);
    }
    ...
    private int getNoOfCommunications(String typeUuid, Date startDateTime, Date endDateTime) throws RemoteException, Exception{
        ...
        sql += "C.employeeUuid='" + employeeUuid + "' ";
        sql += "AND C.typeUuid='" + typeUuid + "' ";
    ...
    private int getCurDayNoOfToDoFollowUps() throws RemoteException, Exception {
        ...
        sql += "C.ownerUuid='" + employeeUuid + "' ";
        sql += "AND C.status='" + Constants.COMMUNICATION_FOLLOW_UP_STATUS_NOT_STARTED + "' ";
    ...
    private Map<String, Integer> getWeekData() throws RemoteException, Exception{
        Map<String, Integer> weekData = new HashMap<String, Integer>();
        weekData.put("CompletedConsultations", getCurWeekNoOfConsultations());
        weekData.put("CompletedFollowUps", getCurWeekNoOfCompletedFollowUps());
