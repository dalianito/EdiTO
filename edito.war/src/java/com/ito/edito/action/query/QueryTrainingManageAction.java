...
public class QueryTrainingManageAction extends AjaxAction {
	...
	public void executeManualUT() throws Exception {
		...
		String sql = "select distinct T.* from TrainingPlan T where T.ifUsing = true and T.stateUuid = '" + Constants.EXAMINATION_STATE_PASSED + "'";
		...
		for (int i = 0; i < list.size(); i++) {
			...
			str[6] = applyInfo != null && applyInfo.getJoinStateUuid() != null ? "1" : "0";
