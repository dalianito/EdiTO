...
public class QueryPartTimeAction extends AjaxAction {
	...
	public void executeManualUT() throws Exception {
		...
		String sqlCondition = "where T.employeeUuid = E.uuid and E.personUuid = P.uuid and T.teacherTypeUuid = '" + Constants.TEACHER_TYPE_PARTTIME + "' and T.ifUsing = true ";
