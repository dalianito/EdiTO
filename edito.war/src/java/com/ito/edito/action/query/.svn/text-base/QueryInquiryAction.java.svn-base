...
public class QueryInquiryAction extends AjaxAction {
	public void executeManualUT() throws Exception {
		...
		sql += "where E.personUuid = P.uuid and E.Uuid = A.applicantUuid and A.Uuid = O.applyUuid  and O.campusUuid = '" + EMPLOYEE.getCampusUuid() + "' and E.ifUsing = true and P.ifUsing = true and O.ifUsing = true ";
