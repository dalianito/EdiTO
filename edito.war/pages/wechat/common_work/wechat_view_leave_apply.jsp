...
<input type="hidden" id="employeeUuid" value="<s:property value="#request.leaveApplication.apply.applicantUuid" />">
...
<br>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="InfoShowPanel">
	<s:if test="apply.checkerOneUuid == null&&apply.checkerTwoUuid == null&&apply.checkerThreeUuid == null">
		<p>等待领导审核中</p>
	</s:if>
	...
	<s:if test="apply.checkerTwoUuid != null">
		...
		<s:if test="apply.state.description == '审核中'">	
			<p>等待领导进一步审核中</p>
		</s:if>
	</s:if>
