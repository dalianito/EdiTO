...
function goBack(){
	...
	location.href = cp + "/whttps/wechat/approval/work/wechat_query_network_review.whtml_" + employeeUuid;
}
</script>
<br>
<p align="center"><img src="<%=request.getContextPath()%>/images/title/title_internetPublicity.gif"></p>
<input type="hidden" id="employeeUuid" value="<s:property value="#request.internetPublicity.reviewEmployeeUuid" />">
...
<br>
<p align="center"><img src="<%=request.getContextPath()%>/images/button/b_back.gif" onClick="goBack()" style="cursor:hand"></p>
<br>
</body>
</html>
