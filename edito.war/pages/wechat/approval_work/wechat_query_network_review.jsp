		...
		for(var i=0;i<data.length;i++){
			if(data[i][0] != null){
				if(data[i][5] == "已审阅"){
					...
					buffer += "<td align='center'><a href='javascript:editInstance(\""+data[i][0]+"\",\"/views/wechat/approval/work/forward_view_network.whtml\")'><img src="+pic+"></a>";
					buffer += "</td>";
					buffer += "</tr>";
				}
...
function goback(){
	...
	location.href = cp + "/whttps/wechat/approval/work/wechat_network_review.whtml_" + employeeUuid;
}
</script>
<form id="form" method="post">
	<input type="hidden" name="uuid">
</form>
<input type="hidden" id="pageTitle" value="已 审 阅 网 络 宣 传 " />
<br>
<table>
	<tr>
