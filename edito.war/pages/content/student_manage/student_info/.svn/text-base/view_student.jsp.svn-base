...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="InfoShowPanel">
	<tr>
		...
		<th width="100">性别</th>
		<td width="100"><s:property value='gender.description' />&nbsp;</td>
	</tr>
	<tr>
		<th width="100">出生日期</th>
		<td width="100"><s:date name='birthDate' format='yyyy-MM-dd' />&nbsp;</td>
		<th width="100">民族</th>
		<td width="100"><s:property value='nationality.description' />&nbsp;</td>
		<th width="100">婚否</th>
		<td width="100"><s:property value='marriage.description' />&nbsp;</td>
	</tr>
	<tr>
		<th width="100">最高学历</th>
		<td width="100"><s:property value='education.description' />&nbsp;</td>
		<th width="100">家长姓名</th>
		<td width="100"><s:property value='parentName' />&nbsp;</td>
		<th width="100">家长电话</th>
		<td width="100"><s:property value='parentPhone' />&nbsp;</td>
	</tr>
	<tr>
		<th width="100">政治面貌</th>
		<td width="100"><s:property value="political.description" />&nbsp;</td>
		<th width="100" >身份证号</th>
		<td width="300" colspan="3" ><s:property value='idNo' />&nbsp;</td>
	</tr>
	<tr>
		<th width="100">电话</th>
		<td width="100"><s:property value='cellPhone' />&nbsp;</td>
		<th width="100" >身份证住址</th>
		<td width="300" colspan="3" ><s:property value='address' />&nbsp;</td>
	</tr>
	<tr>
		<th width="100">QQ</th>
		<td width="100"><s:property value='qq' />&nbsp;</td>
		<th width="100" >实际居住住址</th>
		<td width="300" colspan="3" ><s:property value='realAddress' />&nbsp;</td>
	</tr>
</table>
...
<tr>
	...
	<td width="500" style="height:80px;width:500px;white-space:-moz-pre-wrap;vertical-align:top;padding-top:5px" colspan="5"><pre><s:property value='specialExpertise' /></pre>&nbsp;</td>
</tr>
<tr>
	<th width="100">外语及<br>熟练程度</th>
	<td width="500" style="height:80px;width:500px;white-space:-moz-pre-wrap;vertical-align:top;padding-top:5px" colspan="5"><pre><s:property value='foreignLanguageAndQualification' /></pre>&nbsp;</td>	
</tr>
<s:iterator value="#request.student">
<tr>
