...
<body class="BodyView">
<br>
<p align="center"><img src="<%=request.getContextPath()%>/images/title/title_part_time.gif"></p>
...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="InfoShowPanel">
	...
	<tr>
		...
		<th>职称：</th>
		<td><s:property value="title.description" />&nbsp;</td>
	</tr>
	<tr>
		<th>所在单位：</th>
		<td><s:property value="workUnit" />&nbsp;</td>
		<th>职务：</th>
	...
	<tr>
		<th>授课特色：</th>
		<td colspan="5"><s:property value="feature" />&nbsp;</td>
	</tr>
	<tr>
		<th>备注：</th>
