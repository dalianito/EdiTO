		...
		if(Validation.excuteValidate(elementId)){
			if(confirm("确认操作？")){
				...
				$.post(cp+"/ajaxs/resource/human/manage/contract/manage/info/manage/create_contract.html",param,function(data){
					location.href = cp + "/pages/resource/human/manage/contract/manage/expire/manage/query_expire_manage.html";
				});
			}
		}
	}
...
<a href="<%=request.getContextPath()%>/pages/resource/human/manage/contract/manage/expire/manage/query_expire_manage.html" >
