...
$(document).ready(function(){
	oriUuid = $("label[name='instance(Contract).mouldUuid']").val();
});
</script>
...
<input type="hidden" name="instance(Contract).uuid" value="<s:property value='uuid' />" />
<input type="hidden" name="instance(Contract).timeStamp" value="<s:property value='timeStamp' />" />
<table width="740" border="0" cellpadding="0" cellspacing="0" class="InputPanel">
	<tr>
		<th width="100">模板名称：</th>
		<td width="150"><label name="instance(Contract).mouldUuid" class="BaseTree" javaClassName="ContractMould" ifHasRelated="true" value="<s:property value='mouldUuid' />" validate="true"></label>&nbsp;<font color="#996633">*</font></td>
		<th width="100">合同编号：</th>
		<td width="150"><input name="instance(Contract).contractNo" size="16" value="<s:property value='contractNo' />" validate="true" />&nbsp;<font color="#996633">*</font></td>
		<th width="100">记录人：</th>
		<td width="140">
	...
	<tr>
		<th width="100">签约者：</th>
		<td width="150"><input name="instance(Contract).signer" size="16" value="<s:property value='signer' />" validate="true" />&nbsp;<font color="#996633">*</font></td>
		<th width="100">到期时间：</th>
		<td width="390" colspan="3"><label type="text" name="instance(Contract).expireTime" class="DateTimeSingle" format="all" value="<s:date name='expireTime' format='yyyy-MM-dd HH:mm:ss' />" validate="true"></label>&nbsp;<font color="#996633">*</font></td>
	</tr>
</table>
<br>
<table width="740" border="0" cellpadding="0" cellspacing="0" class="InputPanel">
	...
	<tr>
		<td>
			<FCK:editor instanceName="EditorDefault" inputName="instance(Contract).content" height="500" width="730"></FCK:editor>
