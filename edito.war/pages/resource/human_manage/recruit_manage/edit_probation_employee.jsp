		...
		$.post(cp+"/ajaxs/resource/human/manage/employee/manage/get_employee_if_exist.html",{uuid:uuid,personNo:personNo},function(data){
			if(data != "true"){
				if(confirm("确认操作？")){
					...
					$.post(cp+"/ajaxs/resource/human/manage/recruit/manage/create_probation_employee.html",param,function(){
...
<table width="740" border="0" cellpadding="0" cellspacing="0" class="InputPanel">
	...
	<tr>
		...
		<td width="90">学历</td>
		<td width="120"><label name="instance(Person).educationUuid" class="BaseTree" javaClassName="Education"  validate="true" value="<s:property value='person.educationUuid' />"></label>&nbsp;<font color="#996633">*</font></td>
	</tr>
	<tr>
		<td width="90">校区</td>
		<td width="120"><label name="instance(Employee).campusUuid" class="BaseTree" javaClassName="Campus" validate="true"></label>&nbsp;<font color="#996633">*</font></td>
		<td width="90">岗位</td>
	...
	<tr>
		...
		<td width="90">手机</td>
		<td width="120"><input type="text" name="instance(Person).cellPhone" style="width:90px" validate="true" value="<s:property value='person.cellPhone' />" />&nbsp;<font color="#996633">*</font></td>
		<td width="90">工作电话</td>
		<td width="120"><input type="text" name="instance(Employee).workPhone" style="width:90px" validate="true" />&nbsp;<font color="#996633">*</font></td>
	</tr>
	<tr>
		<td width="90">电子邮件</td>
