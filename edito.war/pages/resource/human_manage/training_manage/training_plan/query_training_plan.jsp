...
function execute(){
	...
	$.ajax({
		type: "POST",
		url: cp+"/ajaxs/resource/human/manage/training/manage/training/plan/query_training_plan.html",
		data:data,
		cache: false,
		dataType: "json",
		success: function(msg){
			if(msg!=null){
				$("#result").pagination({
					totalRecord:msg[1],
					dataStore:msg[0],
					proxyUrl:cp+"/ajaxs/resource/human/manage/training/manage/training/plan/query_training_plan.html",
					data:data,
					currentPage:1,
					perPage:24,
...
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="<%=request.getContextPath()%>/https/resource/human/manage/training/manage/training/plan/create_training_plan.html" >
