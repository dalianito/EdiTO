...
function addData(dataStore){
	...
	buffer += "<tr><th width='20'></th><th width='65'>申请人</th><th width='80'>申请时间</th><th width='65'>分校校长</th><th width='80'>审批时间</th><th width='75'>人力资源处<br>处长</th><th width='80'>审批时间</th><th width='60'>副校长</th><th width='80'>审批时间</th><th width='60'>校长</th><th width='80'>审批时间</th><th width='65'>离职员工</th><th width='50'>审批<br>状态</th><th width='40'>操作</th></tr>";
	if(dataStore.length > 0){
		for(var i=0; i<dataStore.length; i++){
			...
			buffer += "<td align='center'><a href='javascript:showInstance(\""+dataStore[i][13]+"\",\"\",\"/views/resource/human/manage/apply/manage/quit/apply/forward_view_apply.html\",600,700)'>查看</a></td>";
			buffer += "</tr>";
		}
	}
	else {
...
<br>
<div style="font-size:16px;font-weight:bold;margin-top:20px;margin-bottom:10px">员工离职申请</div>
