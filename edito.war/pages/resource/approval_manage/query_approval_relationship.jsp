...
function addData(dataStore){
	...
	buffer += "<tr><th width='20'></th><th width='70'>申请人</th><th width='80'>申请时间</th><th width='130'>人力资源处处长</th><th width='80'>审批时间</th><th width='70'>副校长</th><th width='80'>审批时间</th><th width='70'>校长</th><th width='80'>审批时间</th><th width='80'>转岗人</th><th width='80'>审批状态</th><th width='60'>操作</th></tr>";
	if(dataStore.length > 0){
		for(var i=0; i<dataStore.length; i++){
			...
			buffer += "<td align='center'><a href='javascript:showInstance(\""+dataStore[i][11]+"\",\"\",\"/views/resource/human/manage/apply/manage/relationship/apply/forward_view_apply.html\",600,700)'>查看</a></td>";
			buffer += "</tr>";
		}
	}
	else {
...
<br>
<div style="font-size:16px;font-weight:bold;margin-top:20px;margin-bottom:10px">员工关系调整申请</div>
