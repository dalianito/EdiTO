...
function execute(){
	...
	$.ajax({
		type: "POST",
		url: cp+"/ajaxs/resource/campus/manage/my/campus/network/propaganda/query_network_propaganda.html",
		data:data,
		cache: false,
		dataType: "json",
		success: function(msg){
			if(msg!=null){
				$("#result").pagination({
					totalRecord:msg[1],
					dataStore:msg[0],
					proxyUrl:cp+"/ajaxs/resource/campus/manage/my/campus/network/propaganda/query_network_propaganda.html",
					data:data,
					currentPage:1,
					perPage:24,
...
function addData(dataStore){
	...
	buffer += "<tr><th width='20'></th><th width='80'>记录人</th><th width='150'>记录时间</th><th width='70'>发帖数</th><th width='150'>审阅状态</th><th>操作</th></tr>";
	for(var i=0;i<dataStore.length;i++){
		...
		buffer += "<a href='javascript:showInstance(\""+dataStore[i][3]+"\",\"\",\"/views/resource/campus/manage/my/campus/network/propaganda/forward_view_propaganda.html\",600,700)'>查看</a>&nbsp;";
		buffer += "</td>";
		buffer += "</tr>";
	}
	buffer += "</table></div>";
