...
<body class="BodyView">
<br>
<p align="center"><img src="<%=request.getContextPath()%>/images/title/title_probation_assess.gif"></p>
...
<table width="660" border="0" cellpadding="0" cellspacing="0" class="InfoShowPanel">
	...
	<tr>
		...
		<td width="180"><s:date name='selfAssessTime' format="yyyy-MM-dd HH:MM" />&nbsp;</td>
