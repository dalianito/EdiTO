...
function showContent(time, campusUuid, id, num) {
	$.post(cp+"/ajaxs/resource/campus/manage/campus/human/attendance/inquiry/query_attendance_inquiry.html", {data:time, campusUuid:campusUuid}, function(data){
		var buffer = "";
...
<div style="font-family:黑体;font-size:20px;">&nbsp;考 勤 记 录 总 览</div>
<br><br><br>
